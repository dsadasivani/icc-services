...
public class JwtService {
    public static final String SECRET_KEY = "kcsmUnCGK0OL5uUIf5gWk5e3FsKdpIVqdhr+smgXh+kcm6HCcY1Mvixbo7ZKwCJW";
    ...
    public String generateToken(User userDetails) {
        return generateToken(Map.of("firstName", userDetails.getFirstName(),
